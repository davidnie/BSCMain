###########################################################################
## Makefile generated for Simulink model 'modu'. 
## 
## Makefile     : modu.mk
## Generated on : Mon Sep 05 01:18:30 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\modu.exe
...
MATLAB_BIN                = D:\PROGRA~2\MATLAB\R2014a\bin
MATLAB_ARCH_BIN           = D:\PROGRA~2\MATLAB\R2014a\bin\win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:\work\project\Keil_ST\BSC_UC\mat
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = modu_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = modu_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\modu.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\modu_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=modu -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\modu_grt_rtw\modu.c $(START_DIR)\modu_grt_rtw\modu_data.c $(START_DIR)\modu_grt_rtw\rtGetInf.c $(START_DIR)\modu_grt_rtw\rtGetNaN.c $(START_DIR)\modu_grt_rtw\rt_nonfinite.c $(START_DIR)\modu_grt_rtw\rt_zcfcn.c rt_logging.c
...
OBJS = modu.obj modu_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj rt_logging.obj
...
{$(START_DIR)\modu_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\modu_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
