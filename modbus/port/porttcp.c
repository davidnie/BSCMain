...
//nie void            vMBPortLog( eMBPortLogLevel eLevel, const CHAR * szModule,const CHAR * szFmt, ... );
...
xMBTCPPortSendResponse( const UCHAR * pucMBTCPFrame, USHORT usTCPLength )
{
    ...
    if( pxPCBClient )
    {
     ...
     //nie   assert( tcp_sndbuf( pxPCBClient ) >= usTCPLength );
